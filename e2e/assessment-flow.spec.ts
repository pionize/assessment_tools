...
test.describe('Complete Assessment Flow', () => {
  test('should complete full assessment workflow', async ({ page }) => {
    ...
    // Step 2: Login
    await expect(page.getByRole('heading', { name: /developer assessment/i })).toBeVisible()
    ...
    await page.keyboard.type('// E2E Test Solution\nconsole.log("Hello World");')
    ...
    // Fill in answer
    await page.locator('textarea').fill('This is my system design answer for the E2E test. I would implement a microservices architecture...')
  ...
  test('should handle direct URL access to challenges without login', async ({ page }) => {
  ...
  test('should maintain assessment state across browser tabs', async ({ browser }) => {
