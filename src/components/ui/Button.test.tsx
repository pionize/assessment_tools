...
describe("Button", () => {
	...
	it("should render with primary variant class", () => {
		...
		expect(button).toHaveClass("bg-[#00487a]");
	});
	...
	it("should render with secondary variant class", () => {
		...
		expect(button).toHaveClass("bg-gray-100", "border", "border-gray-300");
	});
	...
	it("should render with ghost variant class", () => {
		...
		expect(button).toHaveClass("text-[#00487a]", "hover:bg-[#00487a]");
	});
	...
	it("should render with small size class", () => {
		...
		expect(button).toHaveClass("px-3", "py-2", "text-sm", "rounded-lg");
	});
