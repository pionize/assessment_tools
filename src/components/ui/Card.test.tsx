...
describe("Card", () => {
	...
	it("should render with default variant styles", () => {
		...
		expect(card).toHaveClass("bg-white/80", "backdrop-blur-sm", "border-white/20", "shadow-lg");
	});
	...
	it("should render with success variant styles", () => {
		...
		expect(card).toHaveClass("border-green-200", "bg-gradient-to-r", "from-green-50/50");
	});
